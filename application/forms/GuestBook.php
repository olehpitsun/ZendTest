...
class Form_GuestBook extends Zend_Form
{
    public function init()
    {
        ...
        $captcha =  new Zend_Form_Element_Captcha(
            'captcha',
            array(
                'label' => 'Введіть текст на картинці',
                'captcha' => array(
                    'captcha' => 'Image',
                    'wordLen' => 3,
                    'timeout' => 900,
		    ...
		    'imgUrl'    => '/public/images/captcha/',
                    'font' => '/var/www/site.com/library/Zend/Captcha/FreeMono.ttf',
        ...
        $this->addElements(array( $username, $email, $website, $text, $captcha, $submit));
    }
}
